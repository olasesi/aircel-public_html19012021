...
class ControllerModuleJournal2StaticBanners extends Controller {
    ...
    public function index($setting) {
        ...
        if (in_array($setting['position'], array('top', 'bottom'))) {
            ...
            $this->journal2->settings->set('module_journal2_static_banners_' . $setting['module_id'] . '_video', Journal2Utils::getVideoBackgroundSettings(Journal2Utils::getProperty($module_data, 'video_background.value.text')));
