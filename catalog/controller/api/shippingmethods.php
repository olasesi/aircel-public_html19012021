...
class ControllerApiShippingmethods extends Controller {
  public function index() {
	...
	if ($this->request->post['option'] == 'pickup') {
	    
        $json['data'] = $method_data['pickup']['quote'];
	    
	} elseif ($this->request->post['option'] == 'deliver') {
        $json['data'] = $method_data['weight']['quote'];
	} else {
	     $json['shipping_methods'] = 'nothing found';
	     $json['post_array'] = $this->request->post;
	}
